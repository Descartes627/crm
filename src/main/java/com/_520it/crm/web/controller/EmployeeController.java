...
public class EmployeeController {
    ...
    //登陆要做5件事，把request存到UserContext的ThreadLocal里，验证登陆，把用户存到UserContext里，把permission存，把menu存
    ...
    public AjaxResult login(String username, String password, HttpServletRequest request) {
        ...
        if (currentUser != null) {
            ...
            // 把用户拥有的权限放入session中，三个表联合 雇员、角色、权限
    ...
    @ResponseBody
    public Map<String, String> hello(String A, String B) {
